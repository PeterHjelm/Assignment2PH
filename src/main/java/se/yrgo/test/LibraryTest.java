...
//        //Task number 5:
        ...
        //Task number 6:
        List<Book> results2 = em.createNamedQuery("searchByGenre", Book.class)
        ...
        public static void setUpData(){
            ...
            Book book1 = new Book("Emil i Lönneberga", "Child-book", 1973);
            Book book2 = new Book("Pippi Långstrump", "Child-book", 1969);
            Book book3 = new Book("Harry Potter och de vises sten", "Fantasy", 2001);
            Book book4 = new Book("Harry Potter och halvblodsprinsen", "Fantasy", 2005);
            Book book5 = new Book("Fladdermusmannen", "Crime", 1997);
            Book book6 = new Book("Snömannen", "Crime", 2007);
